"""
Django settings for test_studio_dev_61550 project.
...
ROOT_URLCONF = 'test_studio_dev_61550.urls'
...
WSGI_APPLICATION = 'test_studio_dev_61550.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_studio_dev_61550 API",
    "DESCRIPTION": "API documentation for test_studio_dev_61550 App",
    "VERSION": "v1",
}
